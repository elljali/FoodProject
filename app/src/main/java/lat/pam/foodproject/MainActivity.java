...
public class MainActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        Log.d("print", String.valueOf(username.equals("rizalsetiawan")));
        Log.d("print", String.valueOf(password.equals("1197050121")));
        //Cek apakah username dan password benar
        if (username.equals("rizalsetiawan") && password.equals("1197050121")) {
